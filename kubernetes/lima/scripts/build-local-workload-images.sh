...
Builds and pushes workload images into the local registry cache for Lima-based
workflows.
...
shell_cli_handle_standard_no_args usage "would build and push Lima workload images into ${CACHE_PUSH_HOST} with tag ${TAG}" "$@"

...
This document captures the current state of Microsoft Entra Easy Auth across the subnetcalc stacks and highlights the practical limitations we have hit when trying to reuse the same user token across multiple App Service hosts.

...
func TestStylesheetServesSharedAppShellRules(t *testing.T) {
	...
	for _, text := range []string{`body > main`, `padding-top: 32px`, `padding-bottom: 32px`, `align-items: center`, `header h1`, `font-size: 2.25rem`, `line-height: 1.15`, `header p`, `.header-actions`, `.auth-state`, `.theme-toggle`, `.sign-in-link`, `min-height: 42px`} {

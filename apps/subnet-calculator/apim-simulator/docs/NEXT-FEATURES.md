...
- behaviors that are easy to verify locally
...
- policy-heavy examples that pair runtime behavior with traces and OTEL
...
3. The feature must document any adapted behavior instead of implying Azure parity.

...
podman build -t subnetcalc-frontend-typescript-vite:latest .

# Run the container
podman run -d -p 3000:8080 subnetcalc-frontend-typescript-vite:latest
...
podman build -t subnetcalc-frontend-typescript-vite-jwt:latest .
...
podman run --rm -p 3001:8080 \
  ...
  subnetcalc-frontend-typescript-vite-jwt:latest
```
...
4. Build container: `podman build -t subnetcalc-frontend-typescript-vite:latest .`
...
Part of the subnetcalc repository.

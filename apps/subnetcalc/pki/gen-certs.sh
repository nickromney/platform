...
Generate or refresh the local development PKI for the subnetcalc compose stack.

$(shell_cli_standard_options)
EOF
}

shell_cli_handle_standard_no_args usage "would generate or refresh subnetcalc local development certificates under ${SCRIPT_DIR}" "$@"

...
@test "platform tui shows disabled action reasons from status json" {
  ...
  cat <<'JSON'
{\"overall_state\":\"running\",\"active_provider\":\"lima\",\"active_provider_path\":\"kubernetes/lima\",\"active_project\":\"lima\",\"active_project_path\":\"kubernetes/lima\",\"foreign_ports\":[],\"projects_order\":[\"kind\"],\"projects\":{\"kind\":{\"path\":\"kubernetes/kind\",\"label\":\"Kind local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[\"kubernetes/lima must be cleared first\"],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/kind.yaml\"}},\"providers\":{\"kind\":{\"path\":\"kubernetes/kind\",\"label\":\"Kind local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[\"kubernetes/lima must be cleared first\"],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/kind.yaml\"},\"lima\":{\"path\":\"kubernetes/lima\",\"label\":\"Kubernetes Lima cluster\",\"state\":\"running\",\"serving\":true,\"runtime_present\":true,\"shared_ports\":[\"127.0.0.1:443\"],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/lima.yaml\"},\"slicer\":{\"path\":\"kubernetes/slicer\",\"label\":\"Slicer local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/slicer.yaml\"}},\"actions\":[{\"id\":\"kind-apply-900\",\"label\":\"Kind stage 900 apply\",\"provider\":\"kind\",\"project\":\"kubernetes/kind\",\"enabled\":false,\"reason\":\"kubernetes/lima must be cleared first\",\"command\":\"make -C kubernetes/kind 900 apply AUTO_APPROVE=1\",\"dangerous\":true}]}
JSON
else
...
EOF
  ...
  write_status_stub "if [[ \"\${3:-}\" == 'json' ]]; then
  cat <<'JSON'
{\"overall_state\":\"idle\",\"active_provider\":null,\"active_provider_path\":null,\"active_project\":null,\"active_project_path\":null,\"foreign_ports\":[],\"projects_order\":[\"kind\"],\"projects\":{\"kind\":{\"path\":\"kubernetes/kind\",\"label\":\"Kind local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/kind.yaml\"}},\"providers\":{\"kind\":{\"path\":\"kubernetes/kind\",\"label\":\"Kind local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/kind.yaml\"},\"lima\":{\"path\":\"kubernetes/lima\",\"label\":\"Kubernetes Lima cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/lima.yaml\"},\"slicer\":{\"path\":\"kubernetes/slicer\",\"label\":\"Slicer local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/slicer.yaml\"}},\"actions\":[{\"id\":\"kind-status\",\"label\":\"Kind status\",\"provider\":\"kind\",\"project\":\"kubernetes/kind\",\"enabled\":true,\"reason\":null,\"command\":\"${action_stub}\",\"dangerous\":false}]}
JSON
else
  printf 'unexpected text fallback\n'
fi"
...
EOF
  ...
  write_status_stub "if [[ \"\${3:-}\" == 'json' ]]; then
  cat <<'JSON'
{\"overall_state\":\"idle\",\"active_provider\":null,\"active_provider_path\":null,\"active_project\":null,\"active_project_path\":null,\"foreign_ports\":[],\"projects_order\":[\"kind\"],\"projects\":{\"kind\":{\"path\":\"kubernetes/kind\",\"label\":\"Kind local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/kind.yaml\"}},\"providers\":{\"kind\":{\"path\":\"kubernetes/kind\",\"label\":\"Kind local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/kind.yaml\"},\"lima\":{\"path\":\"kubernetes/lima\",\"label\":\"Kubernetes Lima cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/lima.yaml\"},\"slicer\":{\"path\":\"kubernetes/slicer\",\"label\":\"Slicer local cluster\",\"state\":\"absent\",\"serving\":false,\"runtime_present\":false,\"shared_ports\":[],\"blockers\":[],\"readiness\":{},\"kubeconfig_path\":\"${BATS_TEST_TMPDIR}/slicer.yaml\"}},\"actions\":[{\"id\":\"kind-apply-900\",\"label\":\"Kind stage 900 apply\",\"provider\":\"kind\",\"project\":\"kubernetes/kind\",\"enabled\":true,\"reason\":null,\"command\":\"${action_stub}\",\"dangerous\":true}]}
JSON
else
  printf 'unexpected text fallback\n'
fi"

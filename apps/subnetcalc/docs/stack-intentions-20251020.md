...
swa 1: public, @subnetcalc/frontend-typescript-vite as frontend, calling backend @api-fastapi-azure-function/
but via a public uri.

- name for swa: swa-subnet-calc-noauth
- custom domain: <https://static-swa-no-auth.publiccloudexperiments.net>
- function app @subnetcalc/api-fastapi-azure-function/ on azure app services
...
swa 2: public, @subnetcalc/frontend-typescript-vite/ as frontend, calling swa linked backend
@subnetcalc/api-fastapi-azure-function/
...
swa 3: private endpoint, @subnetcalc/frontend-typescript-vite/ as frontend, calling swa linked backend
@subnetcalc/api-fastapi-azure-function/

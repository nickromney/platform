...
const runtimeConfig = {
  ...
  AUTH_ENABLED: process.env.AUTH_ENABLED || (authMethod && authMethod !== 'none' ? 'true' : 'false'),
  ...
  OIDC_AUTO_LOGIN: process.env.OIDC_AUTO_LOGIN || 'false',
  OIDC_PROMPT: process.env.OIDC_PROMPT || '',
  OIDC_FORCE_REAUTH: process.env.OIDC_FORCE_REAUTH || 'false',

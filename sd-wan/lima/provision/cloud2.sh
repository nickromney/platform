...
Run the cloud2 guest provisioning steps for the SD-WAN Lima lab.

$(shell_cli_standard_options)
EOF
}

shell_cli_handle_standard_no_args usage "would run cloud2 guest provisioning for the SD-WAN Lima lab" "$@"

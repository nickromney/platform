...
@test "slicer build-local-platform-images calls the shared platform image builder" {
  assert_shared_platform_image_builder "slicer" "build-local-platform-images"
}

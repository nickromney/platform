...
3. **Test users:**
   ...
   - Username: `demo@admin.test`, Password: `demo-password`
...
- Hardcoded passwords (`demo-password`)
...
```bash
AUTH_METHOD=oidc
OIDC_ISSUER=http://keycloak:8080/realms/subnetcalc
...
VITE_OIDC_AUTHORITY=http://localhost:3007/realms/subnetcalc
...
1. Select `subnetcalc` realm (top-left dropdown)
...
# Click "Login" button
# Enter: demo@dev.test / demo-password
...
# Common issues:
# - Wrong issuer URL (should be http://keycloak:8080/realms/subnetcalc)

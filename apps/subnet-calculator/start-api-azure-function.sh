...
Start the local Azure Function API for subnet-calculator development.

$(shell_cli_standard_options)
EOF
}

shell_cli_handle_standard_no_args usage "would start the subnet-calculator Azure Function API on port 7071" "$@"

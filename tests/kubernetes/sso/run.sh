...
PLATFORM_PLAYWRIGHT_MODE="${PLATFORM_PLAYWRIGHT_MODE:-docker}"
...
run_playwright_in_docker() {
  ...
  docker_args+=(
    ...
    -e "SSO_E2E_ENABLE_UAT_APPS=${SSO_E2E_ENABLE_UAT_APPS}"
    -e "SSO_E2E_ENABLE_APIM=${SSO_E2E_ENABLE_APIM}"
    -e "SSO_E2E_ENABLE_GRAFANA=${SSO_E2E_ENABLE_GRAFANA}"
    -e "SSO_E2E_ENABLE_HUBBLE=${SSO_E2E_ENABLE_HUBBLE}"
...
SSO_E2E_ENABLE_UAT_APPS="${SSO_E2E_ENABLE_UAT_APPS:-$(tfvar_bool enable_uat_apps true)}"
SSO_E2E_ENABLE_APIM="${SSO_E2E_ENABLE_APIM:-$(tfvar_bool enable_apim_simulator true)}"
SSO_E2E_ENABLE_GRAFANA="${SSO_E2E_ENABLE_GRAFANA:-$(tfvar_bool enable_grafana true)}"
SSO_E2E_ENABLE_HUBBLE="${SSO_E2E_ENABLE_HUBBLE:-$(tfvar_bool enable_hubble true)}"

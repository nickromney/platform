...
Start the local Container App API for subnetcalc development.

$(shell_cli_standard_options)
EOF
}

shell_cli_handle_standard_no_args usage "would start the subnetcalc Container App API on port 8000" "$@"

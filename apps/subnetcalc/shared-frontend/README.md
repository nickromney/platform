...
```typescript
import type { CloudMode, LookupResult } from '@subnetcalc/shared-frontend'
import { isIpv6, getApiPrefix } from '@subnetcalc/shared-frontend/api'
...
```typescript
import type { HealthResponse, ApiResults } from '@subnetcalc/shared-frontend'
import { handleFetchError, parseJsonResponse } from '@subnetcalc/shared-frontend/api'

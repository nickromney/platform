...
- `cd apps/sentiment-llm/api-sentiment && bun run test`
- `cd apps/sentiment-llm/frontend-react-vite/sentiment-auth-ui && bun run test && bun run build`
...
- `cd apps/sentiment-llm && ./tests/test-tls.sh`
- `cd apps/sentiment-llm && docker compose -f compose.yml -f compose.tls.yml up`
